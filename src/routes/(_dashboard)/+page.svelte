    ...
    <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
      <div class="mx-auto max-w-2xl text-center">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-300">
          ...
          researchers and developers. Re-use your existing code with minimal has
          quisquam.
        </p>
      </div>
    ...
    <div class="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl text-center">
        ...
        <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
          ...
          analytics. Apps for AI and Deep Learning, apps for reporting and image
          processing... even plain old workhorse apps that convert data from one
          format to another. It's all here.
        </p>
