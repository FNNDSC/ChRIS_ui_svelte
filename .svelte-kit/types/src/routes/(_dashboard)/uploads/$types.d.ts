...
type RouteParams = {  }
type RouteId = '/(_dashboard)/uploads';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/(_dashboard)/uploads/+page.server.js').load>>>>>>;
